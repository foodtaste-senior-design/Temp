...
public class EmptyStart_ColorShiftPlatform : MonoBehaviour {
	...
	void setAlpha() {
		...
		if (x_pos <= 100)
			color.a = 0;
		else if (100 < x_pos && x_pos <= 200)
			color.a = (x_pos - 100) / 100;
		else if (200 < x_pos && x_pos <= 250)
			color.a = 1;
		else if (250 < x_pos && x_pos <= 350)
			color.a = 1 - ((x_pos - 250) / 100);
		else
			color.a = 0;
